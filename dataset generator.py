...
#      plt.xticks([4000,400])
      plt.yticks()
      plt.xlabel('Dalga numarası cm-1')
      plt.xlabel('Emilim')
...
#      plt.fill_between(xaxs,spectrum,spectrum2,alpha=.94)
      ...
      titlestring = '50 bileşenli bir analit örneği, sinyal-gürültü oranı 2.0'
...
#  
  ...
  plt.xlabel('Kızılötesi spektrum parmakizi')
  plt.ylabel('Karışımlar')
  plt.show()
...
data = make_data( n_molecules     = 100,
                  n_classes       = 10,
                  n_components    = 50,
                  fraction_limits = (0.0,0.2), # sigma=0.18 and mu=.5
